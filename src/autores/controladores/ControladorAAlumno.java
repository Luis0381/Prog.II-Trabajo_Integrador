...
public class ControladorAAlumno implements IControladorAMAlumno {
     ...
     * Constructor
     */
    private ControladorAAlumno() {
        this.ventana = new VentanaAAlumno(this);
    }

    /**
     * Crea una instancia de ControladorAMAlumno
     */
    public static ControladorAAlumno crear() {
        if (instancia == null)
            instancia = new ControladorAAlumno();
    ...
    public void mostrarVentana(String titulo) {
        if (ventana == null) {
            ventana = new VentanaAAlumno(this);
    ...
    public VentanaAAlumno getVentana() {
        return ventana;
    }

    public void setVentana(VentanaAAlumno ventana) {
